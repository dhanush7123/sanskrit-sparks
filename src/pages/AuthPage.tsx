...
const AuthPage = () => {
  ...
  const handleGuestLogin = () => {
    ...
    toast({
      ...
      description: "You are logged in as a guest. Your progress will be saved locally.",
    });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50 flex flex-col items-center justify-between px-4 pt-4">
      <motion.button
        onClick={() => navigate('/')}
        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="font-mukta">
              Please enter a name to continue as a guest.
            </DialogDescription>
          </DialogHeader>
